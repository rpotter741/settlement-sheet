...
function renderWeeks() {
  ...
  logArea.style =
    "overflow: auto; display: flex; flex-direction: column-reverse; box-sizing: border-box; max-height: 700px";

  if (Object.keys(weekLog).length == 0) {
    logArea.textContent = "You don't have any weekly logs yet.";
    logArea.style =
      "display: flex; justify-content: center; align-items: center; font-size: 16px; text-align: center";
  } else {
...
function displayWeek(week) {
  ...
  eventBox.style =
    "box-sizing: border-box; align-self: start; height: 705px; overflow-y: scroll; scrollbar-width: 50%; border-left: 1px solid rgba(0,0,0.1);";
...
function addLog(value, name) {
  let row = document.createElement("div");
  row.style =
    "display: flex; justify-content: start; align-items: center; gap: 4px; padding-left: 2rem; box-sizing: border-box; width: 100%";
