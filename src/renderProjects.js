...
export default function renderProjects() {
  ...
  projectArray.forEach((event) => {
    ...
    boxOne.style =
      "display:flex; width: 25%; align-items: start; justify-content: start; gap: 1rem; height: 32px;";
    ...
    boxFour.style =
      "display:flex; width: 25%; align-items: start; justify-content: space-between; gap: 1rem;";
    ...
    endBtn.addEventListener("click", () => {
      ...
      let question = confirm(
        "Are you sure you want to end this event? This should only be done at GM direction.",
      );
      if (question == true) {
        endEvent(event);
    ...
    descriptionBox.style =
      "width: 200%; height: 10rem; max-height: 20rem; margin-bottom: .5rem";
    if (event.hide == true) {
    ...
    details.style =
      "overflow-y: scroll; resize: none; font-size: 15px; width: 98%; height: 80%; margin-bottom: .5rem";
