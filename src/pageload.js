...
export default function pageLoad() {
  ...
  firstRow.style =
    "display: grid; grid-template-columns: 1fr 1fr 2fr 1fr 1fr; background: lightgray; height: clamp(100px, 10%; 250px); padding: .5rem;";
  ...
  secondRow.style =
    "display: grid; grid-template-columns: 1fr 1fr 4fr; background: lightgray; height: clamp(100px, 10%; 250px); padding: .5rem;";
  ...
  thirdRow.style =
    "display: grid; grid-template-columns: 1fr 1fr 4fr; grid-template-rows: 1.45fr 1fr; background: lightgray; height: clamp(100px, 10%; 250px); padding: .5rem;";
  ...
  projectManagementBtn.style =
    "background: none; border: none; border-bottom: 2px solid black";
