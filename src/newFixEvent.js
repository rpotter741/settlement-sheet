...
export default function newFixEvent(projCount) {
  ...
  nBB.style =
    "height: 12.5%; width: 50%; display: flex; justify-content: center; align-items: center;";
  ...
  timeVal.type = "number";
  timeVal.style =
    "width: 60%; font-size: 20px; justify-self: start; text-align: center";
  ...
  buttonRow.style =
    "display: flex; justify-content: space-evenly; align-items: center; background: aliceblue; height: 10%;";
  ...
  timeBox.style =
    "font-size: 20px; display: flex; justify-content: start; width: 50%; margin-left: 2rem";
  timeValBox.style =
    "font-size: 20px; display: flex; padding: .15rem; box-sizing: border-box; justify-content: start; width: 50%";
}
...
function createComponent() {
  ...
  if (costCount > 1) {
    let cancelBtn = document.createElement("button");
    cancelBtn.style =
      "height: 28px; border-radius: 1rem; font-size: 16px; border: none; background: none; ;";
