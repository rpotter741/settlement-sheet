...
export default function renderTroops() {
  ...
  troopBox.style =
    "width: 50%; padding-left: 1rem; overflow-y: scroll; box-sizing: border-box; height: 725px; scrollbar-width: none; padding-right: 1rem";
  ...
  troopInfoBox.style =
    "width: 50%; padding: 0 1rem; box-sizing: border-box; border-left: 1px solid rgba(0,0,0,.2); margin-right: 1rem; height: 46.5rem";
...
function renderDeployWindow() {
  ...
  selectorLabel.style =
    "width: 50%; box-sizing: border-box; padding-left: 0rem";
  ...
  if (calcEquipMod() - amod - dmod > 0) {
    equipValue.textContent =
      "+" + (calcEquipMod() - amod - dmod) + " Point(s) Left";
  ...
  intelLabelDef.textContent =
    "Spend Intelligence to grant Resistance equal to Troop Level?";
  ...
  intelLabelOff.textContent =
    "Spend Intelligence to grant bonus damage equal to Troop Level?";
  ...
  if (garrisonFail > 0 && intelFail > 0 && equipmentFail > 0) {
    deployBtn.textContent =
      "Not Enough Intelligence or Garrison; Unallocated Equipment Impact";
    deployBtn.style = "border: dashed red 1px; width: 100%";
  } else if (garrisonFail == 0 && intelFail > 0 && equipmentFail > 0) {
    deployBtn.textContent =
      "Not enough Intelligence; Unallocated Equipment Impact";
    deployBtn.style = "border: dashed red 1px; width: 100%";
  } else if (garrisonFail > 0 && intelFail == 0 && equipmentFail > 0) {
...
function renderTroopBlock(x, y) {
  ...
  for (let i = 0; i < x; i++) {
    ...
    name.style =
      "justify-self: start; border-radius: .5rem; background: lightgray; border: 1px solid black; width: 100%";
