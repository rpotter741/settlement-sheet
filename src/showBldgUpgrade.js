...
export default function showUpgrade(building, lvl) {
  ...
  title.style =
    "font-size: 20px; display: flex; align-items: center; justify-content: center; width: 50%;";
  ...
  if (building.level >= lvl) {
    ...
    failCount++;
    warning.style =
      "font-size: 20px; text-align: center; color: green; margin-top: 2rem";
    wrapper.appendChild(warning);
  } else if (building.level == lvl - 0.5) {
    warning.textContent = "You're already building this upgrade.";
    failCount++;
    warning.style =
      "font-size: 20px; text-align: center; color: red; margin-top: 2rem";
    wrapper.appendChild(warning);
