...
function openSettlementSwap() {
  ...
  overlay.style =
    "background: rgba(0,0,0,.5); height: 100vh; width: 100vw; position: absolute; top: 0; left: 0; z-index: 1";
  ...
  box.style =
    "width: 60rem; height: 30rem; position: absolute; top: calc(50% - 15rem); left: calc(50% - 30rem); z-index: 1; background: aliceblue; border-radius: 1rem; border: 2px solid rgba(0,0,0,.5)";
  box.id = "changeBox";
  ...
  backBox.style =
    "width: 25%; display: flex; justify-content: center; align-items: center";
  ...
  textBox.style =
    "display: flex; justify-content: center; align-items: center; font-size: 22px; width: 50%";
    ...
    "Building Data": [
      {
        ...
        level1: {
          ...
          status:
            "You have Pallisade Walls, granting you a Defense Bonus of +1 and Max Health bonus of +5",
          gold: 350,
          supplies: 8,
        },
        level2: {
          ...
          status:
            "You have Stone Walls, granting you a total Defense Bonus of +2 and total Max Health Bonus of +15 ",
          gold: 1200,
          supplies: 10,
        },
        level3: {
          ...
          status:
            "You have Reinforced Stone Walls, granting you a total Defense Bonus of +3, an Intelligence Bonus of +1, and a Max Health Bonus of +35.",
          gold: 3200,
          supplies: 20,
        },
      },
      {
        ...
        level1: {
          ...
          rewards: {},
          status:
            "You have a Simple Well, reducing weekly health loss from a lack of water from 25 to 20; Drought Event Impacts reduced by 1",
          gold: 100,
          supplies: 2,
        },
        level2: {
          ...
          rewards: {},
          status:
            "You have a Simple Well Network, reducing weekly health loss from a lack of water from 20 - 15; Drought Event Impacts reduced by 2",
          gold: 200,
          supplies: 6,
        },
        level3: {
          ...
          rewards: {},
          status:
            "You have Evaporation Collectors, removing health loss from a lack of water; Drought Impact Events reduced by 4",
          gold: 800,
          supplies: 14,
        },
      },
      {
        ...
        level1: {
          ...
          status:
            "You have a Community Watch Hub, increasing your Intelligence Bonus by +1",
          gold: 150,
          supplies: 2,
          intelligence: 2,
        },
        level2: {
          ...
          status:
            "You have Planted Merchants, increasing your Intelligence Bonus by +2 and preventing weekly Intel loss.",
          gold: 900,
          supplies: 6,
          intelligence: 4,
        },
        level3: {
          ...
          status:
            "You have a SCIF, increasing your Intelligence Bonus by +4, preventing weekly Intel Loss, and unlocking the 'Active ISR' Action",
          gold: 3000,
          supplies: 15,
          intelligence: 7,
        },
      },
      {
        ...
        level1: {
          ...
          status:
            "You have built a Kitchen, increasing your Garrison Bonus by +1. See Troop Info for unlocks; 'Feed the Troops' Action",
          gold: 300,
          supplies: 4,
          food: 4,
        },
        level2: {
          ...
          status:
            "You have a Training Ground, increasing Garrison Bonus by +2. See Troop Info for unlocks; 'Feed the Troops' Action",
          gold: 900,
          supplies: 10,
          "medical capacity": 4,
        },
        level3: {
          ...
          status:
            "You have a War Room, increasing your Garrison Bonus by +4. See Troop Info for unlocks; 'Feed the Troops' Action",
          gold: 3100,
          supplies: 16,
          intelligence: 4,
        },
      },
      {
        ...
        level1: {
          ...
          status:
            "You have Improved Sifters, increasing your Food Bonus by +1; Food Points +2 per week; 'Harvest' Action",
          gold: 125,
          supplies: 4,
        },
        level2: {
          ...
          status:
            "You have Reinforced Silos, increasing your Food Bonus by +2; Food Points +4 per week; 'Harvest' Action",
          gold: 700,
          supplies: 10,
        },
        level3: {
          ...
          status:
            "You have Reinforced Grinder, increasing your Food Bonus by +4; Food Points +7 per week; 'Harvest' Action",
          gold: 2800,
          supplies: 15,
        },
      },
      {
        ...
        level1: {
          ...
          status:
            "You have a Legal Fence, increasing Trade Bonus by +1; Buy at 5% discount; Sell at 2% mark-up",
          gold: 200,
          supplies: 3,
        },
        level2: {
          ...
          status:
            "You have a Night Market, increasing Trade Bonus by +2; Buy at 10% discount; Sell at 5% mark-up",
          gold: 850,
          supplies: 8,
        },
        level3: {
          ...
          status:
            "You have an Auction House, increasing Trade Bonus by +4; Buy at 20% discount; Sell at 10% mark-up; 'Firesale' Action",
          gold: 2500,
          supplies: 12,
        },
      },
      {
        ...
        level1: {
          ...
          status:
            "You have Unionized Blue Collar Workers, increasing Productivity Bonus by +1; Repair Supplies cost decreased by 1; Repair Gold cost reduced by 1 die;",
          gold: 175,
          supplies: 6,
        },
        level2: {
          ...
          status:
            "You have Unionized White Collar Workers; increasing Productivity Bonus by +2; Repair Supplies cost decreased by 2; Repair Gold cost reduced by 2 die",
          gold: 1000,
          supplies: 7,
        },
        level3: {
          ...
          status:
            "You have Funded Worker Representation, increasing Productivity Bonus by +4; Repair Supplies cost decreased by 4; Repair Gold cost reduced by 2 die",
          gold: 2750,
          supplies: 12,
        },
      },
      {
        ...
        level1: {
          ...
          rewards: {},
          status:
            "You have Expanded Classrooms, increasing Troop Lore: Warfare Bonus by +1",
          gold: 250,
          supplies: 4,
        },
        level2: {
          ...
          rewards: {},
          status:
            "You have a Basic Magic Curriculum, increasing Troop Lore: Warfare Bonus by +2; See Troop Info for unlocks",
          gold: 950,
          supplies: 9,
        ...
        level3: {
          ...
          rewards: {},
          status:
            "You have Advanced Magical Theory, increasing Troop Lore: Warfare Bonus by +4; See Troop Info for unlocks",
          gold: 2850,
          supplies: 14,
      ...
      },
      {
        ...
        level1: {
          ...
          status:
            "You have Sterilization Stations, increasing Medical Bonus by +1; Weekly Healing increased by +2; Damage decreased by 10% (min 1)",
          gold: 275,
          "medical capacity": 2,
        },
        level2: {
          ...
          status:
            "You have Operating Rooms, increasing Medical Bonus by +2; Weekly Healing increased by + 4; Damage decreased by 20% (min 1)",
          gold: 750,
          "medical capacity": 6,
        },
        level3: {
          ...
          status:
            "You have Health Education, increasing Medical Bonus by +4; Weekly Healing increased by +8; Damage decreased by 33% (min 1)",
          gold: 2900,
          supplies: 15,
          "medical capacity": 11,
        },
      },
      {
        ...
        level1: {
          ...
          rewards: {},
          status:
            "You have a Census Office, increasing Weekly Tax Gain by 10%; Available Item Level increased by +1",
          gold: 225,
          supplies: 2,
        },
        level2: {
          ...
          rewards: {},
          status:
            "You have an Internal Revenue Office, increasing Weekly Tax Gain by 15%; Available Item Level increased by +2",
          gold: 875,
          supplies: 6,
        },
        level3: {
          ...
          rewards: {},
          status:
            "You have an Economic Office, increasing Weekly Tax Gain by 25%; Available Item Level increase by +4",
          gold: 2700,
          supplies: 18,
        },
      },
