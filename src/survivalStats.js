...
function medBox() {
  ...
  if (
    ...
    toolTip.textContent =
      "Spend 3 Settlement Points to gain 1 Medical Capacity";
  } else if (settlement.type == "Survivalist") {
    toolTip.textContent =
      "Spend 2 Settlement Points to gain 1 Medical Capacity";
  }
  toolTip.classList.add("tooltiptext");
  spBuy.appendChild(toolTip);
...
let surActions = [
  {
    ...
    type: "food",
    description:
      "A party memeber can attempt a Nature or Survival check to forage for fruits and vegetables. DC may be affected by the current season or ongoing events.",
  },
  {
    name: "Hunt for Food",
    id: "huntFood",
    type: "food",
    description:
      "A party memeber can attempt a Perception or Survival check to hunt animals for food. DC may be affected by the current season or ongoing events.",
  },
  {
    name: "Discover Water",
    id: "discoverWater",
    type: "water",
    description:
      "A party member can attempt a Nature or Survival check to find a source of water.",
  },
  {
    ...
    type: "supplies",
    description:
      "A party member can attempt an Athletics, Survival, or Nature check to gather raw materials for use in the settlement.",
  },
  {
    ...
    description:
      "A party member can attempt an Athletics, Diplomacy, Intimidation, or Society check to clean or encourage others to clean the streets, decreasing the likelihood of disease spreading through the population.",
  },
  {
    ...
    type: "medical capacity",
    description:
      "A party member can attempt a Medicine, Nature, Occult, or Religion check to treat the sick and injured in the settlement. This action affects settlement health, but cannot increase it above its maximum (or override other ongoing effects).",
  },
];
...
function showSurAction(item) {
  ...
  header.style =
    "display: flex; justify-content: center; width: 100%; background: rgba(200,200,230,.5); padding: 1rem; box-sizing: border-box; border-radius: .5rem .5rem 0 0;";
