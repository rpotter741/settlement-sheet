...
function renderDeployed() {
  ...
  wrapper.innerHTML = "";
  wrapper.style =
    "background: rgba(211,211,211,.3); height: 37rem; border-radius: .5rem; overflow-y: scroll; scrollbar-width: none";
  ...
  deployedArray.forEach((deployment) => {
    ...
    currentHealth.style =
      "width: 33%; border: none; background: rgba(250,250,250,.2)";
    ...
    cxBtn.addEventListener("click", () => {
      let answer = confirm(
        "Are you sure you want to send this troop home? Troops lower than 50% health will NOT restore Garrison.",
      );
    ...
    noteArea.style =
      "height: 10rem; resize: none; overflow-y: scroll; scrollbar-width: none; width: 100%";
...
export { deployedArray, renderDeployed, setDeployed };
