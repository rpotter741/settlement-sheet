...
function nextWeek() {
  if (calcWorkers() < 0) {
    alert(
      "You've assigned more workers than you have available. Make sure Productivity Available is at or above 0.",
    );
    return;
  }
  clearList();
...
function recoverHealth() {
  ...
  if (
    ...
    parseInt(settlement.maxHealthBase + settlement.maxHealthBonus)
  ) {
    settlement.currentHealth = parseInt(
